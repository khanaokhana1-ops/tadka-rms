document.write(`
  <div class="card" style="display:flex; gap:8px; flex-wrap:wrap; padding:12px;">
    <a href="dashboard.html" style="text-decoration:none;"><button class="btn btn-secondary">Restaurant Info</button></a>
